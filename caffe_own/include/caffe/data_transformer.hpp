...
class DataTransformer {
 public:
  ...
  // It will also write back the coordinate for the center of the crops
  void Transform_coord(const cv::Mat& cv_img, Blob<Dtype>* transformed_blob, int& coord_x, int& coord_y);
