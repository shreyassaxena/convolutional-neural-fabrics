...
class BaseConvolutionLayer : public Layer<Dtype> {
 ...
 void forward_cpu_gemm_sparse(const Dtype* input, const Dtype* weights,
      Dtype* output, bool skip_im2col = false);
  ...
  void set_sparse_connect_filter();  // shreyas add
  void set_sparse_connect_filter_higher_to_lower();  // shreyas add
  void set_sparse_connect_filter_lower_to_higher();  // shreyas add
  ...
  bool bias_term_;
  bool is_sparse_connect_;   // Shreyas add.
  bool is_sparse_connect_higher_to_lower;   // Shreyas add.
  bool is_sparse_connect_lower_to_higher;   // Shreyas add.
  Blob<Dtype> blanking_blob_;   // Shreyas add
  bool is_1x1_;
...
class PoolingLayer : public Layer<Dtype> {
 public:
  ...
  virtual inline int MaxTopBlobs() const {
    if( this->layer_param_.pooling_param().pool() == PoolingParameter_PoolMethod_TOPLEFT){
        return 2;
    }
